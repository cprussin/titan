...
const power: SessionTemplate = {
  ...
  slots: [
    ...
    {
      base: Prescription.TimedCarry({ durationSec: 40, sets: 4, weight: 185 }),
      exerciseId: "farmer-carry",
      generateWarmup: false,
      id: "power-day-farmer-carry",
      note: "Four heavy carries, 40 seconds each, 90 seconds between them. Progress by load, never by walking longer.",
