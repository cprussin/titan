...
const heavyLower: SessionTemplate = {
  ...
  slots: [
    ...
    {
      base: Prescription.Strength({ reps: 5, sets: 3, weightLb: 205 }),
...
const heavyPull: SessionTemplate = {
  ...
  slots: [
    ...
    {
      base: Prescription.Strength({ reps: 5, sets: 3, weightLb: 155 }),
...
const power: SessionTemplate = {
  ...
  slots: [
    ...
    {
      base: Prescription.Strength({ reps: 1, sets: 4, weightLb: 185 }),
